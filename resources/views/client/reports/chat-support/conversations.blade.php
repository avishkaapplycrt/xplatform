...
@section('title', 'Chat & Support - Conversations')
...
<div class="flex flex-col h-full overflow-hidden bg-white">
  ...
  <header class="flex-shrink-0 bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between">
    <div class="flex items-center gap-3">
      ...
      <div>
        <h1 class="text-[16px] font-semibold text-gray-900">Conversations</h1>
        <p class="text-[11px] text-gray-500 mt-0.5">Analyze chat volume and topics</p>
      </div>
    </div>
    <div class="flex items-center gap-3">
  ...
  <div class="flex-1 overflow-y-auto px-5 py-5">
    ...
    <div class="flex items-center gap-1 mb-5 border-b border-gray-200 pb-0">
      ...
      <a href="{{ route('client.reports.chat-support.conversations') }}" class="px-4 py-2.5 text-[12px] font-medium rounded-t-lg transition text-blue-600 border-b-2 border-blue-600 bg-blue-50/50" style="text-decoration: none;">
        Conversations
      </a>
    ...
    <div class="bg-white border border-gray-200 rounded-xl p-8 text-center">
      <p class="text-[14px] text-gray-600">Conversation analytics coming soon.</p>
    </div>
    @else
    <div class="bg-white border border-gray-200 rounded-xl p-8 text-center">
