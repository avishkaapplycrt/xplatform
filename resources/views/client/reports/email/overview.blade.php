...
@section('title', 'Email Analytics - Overview')
...
<div class="flex flex-col h-full overflow-hidden bg-white">
  ...
  <header class="flex-shrink-0 bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between">
    <div class="flex items-center gap-3">
      ...
      <div>
        <h1 class="text-[16px] font-semibold text-gray-900">Email Analytics</h1>
        <p class="text-[11px] text-gray-500 mt-0.5">Track email campaigns and engagement</p>
      </div>
    </div>
    <div class="flex items-center gap-3">
  ...
  <div class="flex-1 overflow-y-auto px-5 py-5">
    ...
    <div class="flex items-center gap-1 mb-5 border-b border-gray-200 pb-0">
      <a href="{{ route('client.reports.email.overview') }}" class="px-4 py-2.5 text-[12px] font-medium rounded-t-lg transition text-blue-600 border-b-2 border-blue-600 bg-blue-50/50" style="text-decoration: none;">
        Overview
      </a>
      <a href="{{ route('client.reports.email.campaigns') }}" class="px-4 py-2.5 text-[12px] font-medium rounded-t-lg transition text-gray-500 hover:text-gray-700 hover:bg-gray-50" style="text-decoration: none;">
        Campaigns
      </a>
      <a href="{{ route('client.reports.email.audience') }}" class="px-4 py-2.5 text-[12px] font-medium rounded-t-lg transition text-gray-500 hover:text-gray-700 hover:bg-gray-50" style="text-decoration: none;">
        Audience
      </a>
      <a href="{{ route('client.reports.email.engagement') }}" class="px-4 py-2.5 text-[12px] font-medium rounded-t-lg transition text-gray-500 hover:text-gray-700 hover:bg-gray-50" style="text-decoration: none;">
        Engagement
      </a>
      <a href="{{ route('client.reports.email.deliverability') }}" class="px-4 py-2.5 text-[12px] font-medium rounded-t-lg transition text-gray-500 hover:text-gray-700 hover:bg-gray-50" style="text-decoration: none;">
        Deliverability
      </a>
    </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-5">
      ...
      <div class="bg-white border border-gray-200 rounded-xl p-4">
        <p class="text-[11px] text-gray-500 font-medium mb-1">Open Rate</p>
        <p class="text-[20px] font-bold text-gray-900">{{ $data['open_rate'] ?? 0 }}%</p>
      </div>
      <div class="bg-white border border-gray-200 rounded-xl p-4">
        <p class="text-[11px] text-gray-500 font-medium mb-1">Click Rate</p>
        <p class="text-[20px] font-bold text-gray-900">{{ $data['click_rate'] ?? 0 }}%</p>
      </div>
      <div class="bg-white border border-gray-200 rounded-xl p-4">
      ...
      <div class="bg-white border border-gray-200 rounded-xl p-4">
        <p class="text-[11px] text-gray-500 font-medium mb-1">Unsubscribe</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-5">
      <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
        <div class="px-4 py-3 border-b border-gray-100">
          <h6 class="text-[13px] font-semibold text-gray-800">Email Trend</h6>
        </div>
        <div class="p-4">
          <canvas id="emailTrendChart" height="250"></canvas>
        </div>
      </div>
      <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
        <div class="px-4 py-3 border-b border-gray-100">
          <h6 class="text-[13px] font-semibold text-gray-800">Engagement Breakdown</h6>
        </div>
        <div class="p-4">
    ...
    <div class="bg-white border border-gray-200 rounded-xl p-8 text-center">
      ...
      <h3 class="text-[14px] font-semibold text-gray-800 mb-1">No Email data yet</h3>
      <p class="text-[12px] text-gray-500 mb-4">Connect your Email account to start tracking analytics.</p>
      <a href="{{ route('client.email-connections') }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-green-600 text-white text-[12px] font-medium rounded-lg hover:bg-green-700 transition" style="text-decoration: none;">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
