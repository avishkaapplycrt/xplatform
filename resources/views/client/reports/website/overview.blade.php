...
@section('title', 'Website Analytics - Overview')
...
<div class="flex flex-col h-full overflow-hidden bg-white">
  ...
  <header class="flex-shrink-0 bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between">
    <div class="flex items-center gap-3">
      ...
      <div>
        <h1 class="text-[16px] font-semibold text-gray-900">Website Analytics</h1>
        <p class="text-[11px] text-gray-500 mt-0.5">Track visitors, pageviews, and user behavior</p>
      </div>
    </div>
    <div class="flex items-center gap-3">
  ...
  <div class="flex-1 overflow-y-auto px-5 py-5">
    <div class="flex items-center gap-1 mb-5 border-b border-gray-200 pb-0">
      <a href="{{ route('client.reports.website.overview') }}" class="px-4 py-2.5 text-[12px] font-medium rounded-t-lg transition text-blue-600 border-b-2 border-blue-600 bg-blue-50/50" style="text-decoration: none;">
        Overview
      </a>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-5">
      <div class="bg-white border border-gray-200 rounded-xl p-4">
        ...
        <p class="text-[20px] font-bold text-gray-900">{{ number_format($data['total_visitors'] ?? 0) }}</p>
      </div>
      <div class="bg-white border border-gray-200 rounded-xl p-4">
        <p class="text-[11px] text-gray-500 font-medium mb-1">Unique Visitors</p>
        <p class="text-[20px] font-bold text-gray-900">{{ number_format($data['unique_visitors'] ?? 0) }}</p>
      </div>
      <div class="bg-white border border-gray-200 rounded-xl p-4">
        <p class="text-[11px] text-gray-500 font-medium mb-1">Pageviews</p>
        <p class="text-[20px] font-bold text-gray-900">{{ number_format($data['total_pageviews'] ?? 0) }}</p>
      </div>
      <div class="bg-white border border-gray-200 rounded-xl p-4">
      ...
      <div class="bg-white border border-gray-200 rounded-xl p-4">
        <p class="text-[11px] text-gray-500 font-medium mb-1">Avg Session</p>
        <p class="text-[20px] font-bold text-gray-900">{{ $data['avg_session_duration'] ?? '0m' }}</p>
      </div>
      <div class="bg-white border border-gray-200 rounded-xl p-4">
        <p class="text-[11px] text-gray-500 font-medium mb-1">Pages/Session</p>
        <p class="text-[20px] font-bold text-gray-900">{{ $data['pages_per_session'] ?? 0 }}</p>
      </div>
      <div class="bg-white border border-gray-200 rounded-xl p-4">
        <p class="text-[11px] text-gray-500 font-medium mb-1">New Visitors</p>
        <p class="text-[20px] font-bold text-gray-900">{{ $data['new_vs_returning']['new'] ?? 0 }}%</p>
      </div>
      <div class="bg-white border border-gray-200 rounded-xl p-4">
        <p class="text-[11px] text-gray-500 font-medium mb-1">Returning</p>
        <p class="text-[20px] font-bold text-gray-900">{{ $data['new_vs_returning']['returning'] ?? 0 }}%</p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-5">
      <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
        <div class="px-4 py-3 border-b border-gray-100">
          <h6 class="text-[13px] font-semibold text-gray-800">Traffic Trend</h6>
        </div>
        <div class="p-4">
      ...
      <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
        <div class="px-4 py-3 border-b border-gray-100">
          <h6 class="text-[13px] font-semibold text-gray-800">Device Breakdown</h6>
        </div>
        <div class="p-4">
