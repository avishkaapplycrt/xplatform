...
@section('title', 'Transaction Analytics - Sales Funnel')
...
<div class="flex flex-col h-full overflow-hidden bg-white">
  ...
  <div class="flex-1 overflow-y-auto px-5 py-5">
    ...
    <div class="flex items-center gap-1 mb-5 border-b border-gray-200 pb-0">
      ...
      <a href="{{ route('client.reports.transactions.sales-funnel') }}" class="px-4 py-2.5 text-[12px] font-medium rounded-t-lg transition text-blue-600 border-b-2 border-blue-600 bg-blue-50/50" style="text-decoration: none;">
        Sales Funnel
      </a>
