...
<style>
  ...
  .step-card:hover {
    border-color: #0c0c0c;
    box-shadow: 0 4px 16px #0c0c0c14;
  }
  .step-number {
    width: 36px;
    height: 36px;
...
<header class="flex-shrink-0 bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between">
  <div class="flex items-center gap-3">
    ...
    <div class="flex items-center gap-2">
      ...
      <div>
        <h1 class="text-[16px] font-semibold text-gray-900">Connect Wix</h1>
...
<div class="flex-1 overflow-y-auto px-5 py-4">
  ...
  <div id="step-1" class="step-card mb-4">
    <div class="flex items-start gap-4">
      ...
      <div class="flex-1">
        <h3 class="text-[14px] font-bold text-gray-900 mb-1">Enter Your Wix Site Details</h3>
        <p class="text-[12px] text-gray-500 mb-4">Provide your Wix site URL and choose how you want to integrate tracking.</p>

        <form id="connectForm" onsubmit="submitConnection(event)">
          <input type="hidden" id="modalPlatform" name="platform" value="wix">
          ...
          <div class="grid grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <p class="form-hint">The full URL of your Wix site</p>
            </div>
            <div>
              <label class="form-label">Site Name <span class="text-gray-400 font-normal">(optional)</span></label>
              <input type="text" name="site_name" class="form-input" placeholder="My Wix Site"
          ...
          <div class="mb-4">
            ...
            <div class="flex gap-2 mb-3">
              <button type="button" class="method-tab active" onclick="switchMethod('app')">Wix App Market</button>
              <button type="button" class="method-tab" onclick="switchMethod('manual')">Custom Code</button>
            </div>

            <div id="method-app" class="method-panel active">
              <div class="info-box mb-3">
                <p class="info-box-title">Wix App Market</p>
                <p class="info-box-text">Install our official app from the Wix App Market for automatic tracking setup.</p>
              </div>
              <div class="mt-3">
              <div class="install-step"><div class="install-step-num">1</div><div class="install-step-text">Go to your Wix Editor → Apps → App Market</div></div>
              ...
              <div class="install-step"><div class="install-step-num">3</div><div class="install-step-text">Click Add to Site and grant permissions</div></div>
              <div class="install-step"><div class="install-step-num">4</div><div class="install-step-text">Enter your tracking code in the app settings</div></div>
            </div>
            </div>

            <div id="method-manual" class="method-panel">
              <div class="info-box mb-3">
                <p class="info-box-title">Custom Code</p>
                <p class="info-box-text">Manually add the tracking code using Wix Custom Code feature.</p>
              </div>
              <div class="mt-3">
              <div class="install-step"><div class="install-step-num">1</div><div class="install-step-text">Go to Settings → Custom Code in your Wix dashboard</div></div>
              <div class="install-step"><div class="install-step-num">2</div><div class="install-step-text">Click "+ Add Custom Code"</div></div>
              <div class="install-step"><div class="install-step-num">3</div><div class="install-step-text">Paste the tracking code and select "All Pages"</div></div>
              <div class="install-step"><div class="install-step-num">4</div><div class="install-step-text">Place code in the Head section and click Apply</div></div>
            </div>
            </div>
          </div>
  ...
  <div id="step-2" class="step-card mb-4">
    <div class="flex items-start gap-4">
      ...
      <div class="flex-1">
        ...
        <p class="text-[12px] text-gray-500 mb-4">Add this tracking code to your Wix site to start collecting events.</p>

        <div id="install-app" class="method-panel active">
          <div class="info-box mb-3">
            <p class="info-box-title">Wix App Market Installation</p>
  ...
  <div id="step-3" class="step-card mb-4">
    <div class="flex items-start gap-4">
      ...
      <div class="flex-1">
        ...
        <p class="text-[12px] text-gray-500 mb-4">Your Wix site is now connected and tracking events.</p>
        ...
        <div class="flex items-center gap-3">
          <a href="{{ route('client.website-connections.analytics', $connection->id) }}" class="connect-submit-btn" style="text-decoration:none; background:#374151;">
            <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
...
function disconnectSite() {
  if (!currentConnectionId) return;
  if (!confirm('Are you sure you want to disconnect this Wix site? All tracking will stop.')) return;
  ...
  .then(res => {
    if (res.success) {
      alert('Wix site disconnected successfully.');
