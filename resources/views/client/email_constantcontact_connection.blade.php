...
@section('title', 'Connect Constant Contact')

@push('styles')
<style>
  .provider-connect-page { max-width: 720px; margin: 0 auto; }
  .provider-hero { text-align: center; padding: 32px 24px; border-radius: 16px; background: linear-gradient(135deg, #1856ed15 0%, #1856ed08 100%); border: 1px solid #1856ed30; margin-bottom: 24px; }
  ...
  .panel-title .dot { width: 8px; height: 8px; border-radius: 50%; background: #1856ed; }
  ...
  .form-input:focus { outline: none; border-color: #1856ed; box-shadow: 0 0 0 3px #1856ed20; }
  ...
  .scope-tag { padding: 3px 10px; border-radius: 20px; font-size: 10px; font-weight: 600; background: #1856ed15; color: #1856ed; border: 1px solid #1856ed30; }
...
<header class="flex-shrink-0 bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between">
  <div class="flex items-center gap-3">
    ...
    <div>
      <h1 class="text-[16px] font-semibold text-gray-900">Connect Constant Contact</h1>
...
<div class="flex-1 overflow-y-auto px-5 py-4">
  ...
  <div class="provider-connect-page">
    ...
    <div class="provider-hero">
      ...
      <p>Sync your Constant Contact lists, campaigns, and email performance metrics.</p>
    ...
    <div class="panel-card">
      ...
      <div class="features-list">
          <div class="feature-item">
            <div class="feature-check" style="background: #1856ed20; color: #1856ed;">
              <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/>
              </svg>
            </div>
            <span class="feature-text">Sync email campaigns and reports</span>
          </div>
          <div class="feature-item">
            <div class="feature-check" style="background: #1856ed20; color: #1856ed;">
              <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24">
            ...
            <span class="feature-text">Import contact lists and tags</span>
          </div>
          <div class="feature-item">
            <div class="feature-check" style="background: #1856ed20; color: #1856ed;">
              <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24">
            ...
            <span class="feature-text">Track opens, clicks, and unsubscribes</span>
          </div>
          <div class="feature-item">
            <div class="feature-check" style="background: #1856ed20; color: #1856ed;">
              <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24">
            ...
            <span class="feature-text">Monitor list growth and engagement trends</span>
          </div>
      </div>
    </div>
    ...
    <div class="panel-card">
      ...
      <div class="setup-steps">
        <div class="step-item">
          <div class="step-num" style="background: #1856ed20; color: #1856ed;">1</div>
          <p class="step-text">Generate an API key from your Constant Contact account</p>
        </div>
        <div class="step-item">
          <div class="step-num" style="background: #1856ed20; color: #1856ed;">2</div>
          <p class="step-text">Paste the API key in the field below</p>
        </div>
        <div class="step-item">
          <div class="step-num" style="background: #1856ed20; color: #1856ed;">3</div>
          <p class="step-text">Click "Connect with Constant Contact"</p>
        </div>
        <div class="step-item">
          <div class="step-num" style="background: #1856ed20; color: #1856ed;">4</div>
    ...
    <div class="panel-card">
      ...
      <div class="scopes-list">
        <span class="scope-tag">contact_data</span>
        <span class="scope-tag">campaign_data</span>
        <span class="scope-tag">account_info</span>
      </div>
    </div>
      ...
      <form id="apiKeyForm" onsubmit="return connectApiKey(event)">
        <div class="form-group">
          ...
          <div class="input-wrap">
            <input type="password" id="apiKeyInput" class="form-input" placeholder="Enter your Constant Contact API key" required>
          ...
          <p class="form-help">Find your API key in Constant Contact → My Account → API Keys</p>
        </div>
        <div class="form-group">
          <label class="form-label">Account Name (Optional)</label>
          <input type="text" id="accountNameInput" class="form-input" placeholder="e.g. My Constant Contact Account">
        </div>
        <button type="submit" class="connect-action-btn" style="background: #1856ed; color: #ffffff;">
          <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
...
function disconnect() {
  if (!confirm('Are you sure you want to disconnect Constant Contact? All synced data will be removed.')) return;
...
function connectApiKey(e) {
  ...
  fetch('{{ route("client.email-connections.store") }}', {
    ...
    body: JSON.stringify({
      ...
      settings: JSON.stringify({ color: '#1856ed', text_color: '#ffffff' })
    })
  })
  .then(r => r.json())
  .then(res => {
