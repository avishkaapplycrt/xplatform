...
<header class="flex-shrink-0 bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between">
  <div class="flex items-center gap-3">
    ...
    <div class="flex items-center gap-2">
      ...
      <div>
        <h1 class="text-[16px] font-semibold text-gray-900">Wix Analytics</h1>
  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
    ...
    <div class="analytics-card lg:col-span-2">
      ...
      <div class="empty-state">
        ...
        <div class="empty-state-text">Events will appear once visitors interact with your Wix site.</div>
      </div>
      @endif
    </div>
    ...
    <div class="analytics-card">
      ...
      @php
        ...
        $colors = ['#0c0c0c', '#22c55e', '#3b82f6', '#f59e0b', '#ec4899', '#8b5cf6', '#06b6d4'];
      @endphp
      <div class="space-y-3">
