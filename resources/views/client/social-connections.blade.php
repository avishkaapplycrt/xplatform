{{-- resources/views/client/social-connections.blade.php --}}
@extends('layouts.platform')

@section('title', 'Social Media Connections')
...
<div class="flex flex-col h-full overflow-hidden bg-white">
  ...
  <header class="flex-shrink-0 bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between">
    <div>
      <h1 class="text-[16px] font-semibold text-gray-900">Social Media Connections</h1>
    ...
    <div class="flex items-center gap-4 text-[11px] text-gray-500">
      ...
      <span class="flex items-center gap-1.5">
        ...
        <span class="font-medium text-gray-600">{{ number_format($totalFollowers) }} followers</span>
      </span>
