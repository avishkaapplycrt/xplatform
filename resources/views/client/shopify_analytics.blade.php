...
@section('title', 'Shopify Analytics')
...
<style>
  ...
  .event-icon.add_to_cart { background: #fef3c7; color: #d97706; }
  .event-icon.purchase { background: #dcfce7; color: #16a34a; }
  ...
  .shopify-bg { background: #95bf47; }
  .shopify-border { border-color: #95bf47; }
</style>
@endpush
...
<header class="flex-shrink-0 bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between">
  <div class="flex items-center gap-3">
    ...
    <div class="flex items-center gap-2">
      ...
      <div>
        <h1 class="text-[16px] font-semibold text-gray-900">Shopify Analytics</h1>
...
<div class="flex-1 overflow-y-auto px-5 py-4">
  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
    ...
    <div class="analytics-card lg:col-span-2">
      ...
      <div class="empty-state">
        ...
        <div class="empty-state-text">Events will appear once visitors interact with your Shopify store.</div>
      </div>
      @endif
    </div>
    ...
    <div class="analytics-card">
      ...
      @php
        ...
        $colors = ['#95bf47', '#22c55e', '#3b82f6', '#f59e0b', '#ec4899', '#8b5cf6', '#06b6d4'];
      @endphp
      <div class="space-y-3">
      ...
      <div class="space-y-1 max-h-[320px] overflow-y-auto pr-1">
        ...
        @php
          ...
          $iconMap = [
            ...
            'add_to_cart' => '<path d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"/>',
            'purchase' => '<path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>',
          ];
  ...
  <div class="analytics-card">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 text-[12px]">
      ...
      <div>
        <p class="text-gray-400 mb-1">Store URL</p>
