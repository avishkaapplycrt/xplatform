...
@section('title', 'Connect MailerLite')

@push('styles')
<style>
  .provider-connect-page { max-width: 720px; margin: 0 auto; }
  .provider-hero { text-align: center; padding: 32px 24px; border-radius: 16px; background: linear-gradient(135deg, #00aaff15 0%, #00aaff08 100%); border: 1px solid #00aaff30; margin-bottom: 24px; }
  ...
  .panel-title .dot { width: 8px; height: 8px; border-radius: 50%; background: #00aaff; }
  ...
  .form-input:focus { outline: none; border-color: #00aaff; box-shadow: 0 0 0 3px #00aaff20; }
  ...
  .scope-tag { padding: 3px 10px; border-radius: 20px; font-size: 10px; font-weight: 600; background: #00aaff15; color: #00aaff; border: 1px solid #00aaff30; }
...
<header class="flex-shrink-0 bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between">
  <div class="flex items-center gap-3">
    ...
    <div>
      <h1 class="text-[16px] font-semibold text-gray-900">Connect MailerLite</h1>
...
<div class="flex-1 overflow-y-auto px-5 py-4">
  ...
  <div class="provider-connect-page">
    ...
    <div class="provider-hero">
      ...
      <h2>MailerLite</h2>
      <p>Connect MailerLite to track subscriber activity, automations, and campaign stats.</p>
    ...
    <div class="panel-card">
      ...
      <div class="features-list">
          <div class="feature-item">
            <div class="feature-check" style="background: #00aaff20; color: #00aaff;">
              <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/>
              </svg>
            </div>
            <span class="feature-text">Sync subscriber lists and groups</span>
          </div>
          <div class="feature-item">
            <div class="feature-check" style="background: #00aaff20; color: #00aaff;">
              <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24">
            ...
            <span class="feature-text">Import campaign data and reports</span>
          </div>
          <div class="feature-item">
            <div class="feature-check" style="background: #00aaff20; color: #00aaff;">
              <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24">
            ...
            <span class="feature-text">Track subscriber activity and engagement</span>
          </div>
          <div class="feature-item">
            <div class="feature-check" style="background: #00aaff20; color: #00aaff;">
              <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24">
            ...
            <span class="feature-text">Monitor automation workflows</span>
          </div>
      </div>
    </div>
    ...
    <div class="panel-card">
      ...
      <div class="setup-steps">
        <div class="step-item">
          <div class="step-num" style="background: #00aaff20; color: #00aaff;">1</div>
          <p class="step-text">Generate an API key from your MailerLite account</p>
        </div>
        <div class="step-item">
          <div class="step-num" style="background: #00aaff20; color: #00aaff;">2</div>
          <p class="step-text">Paste the API key in the field below</p>
        </div>
        <div class="step-item">
          <div class="step-num" style="background: #00aaff20; color: #00aaff;">3</div>
          <p class="step-text">Click "Connect with MailerLite"</p>
        </div>
        <div class="step-item">
          <div class="step-num" style="background: #00aaff20; color: #00aaff;">4</div>
    ...
    <div class="panel-card">
      ...
      <div class="scopes-list">
        ...
        <span class="scope-tag">groups</span>
      ...
      <form id="apiKeyForm" onsubmit="return connectApiKey(event)">
        <div class="form-group">
          ...
          <div class="input-wrap">
            <input type="password" id="apiKeyInput" class="form-input" placeholder="Enter your MailerLite API key" required>
          ...
          <p class="form-help">Find your API key in MailerLite → Account → Integrations → Developer API</p>
        </div>
        <div class="form-group">
          <label class="form-label">Account Name (Optional)</label>
          <input type="text" id="accountNameInput" class="form-input" placeholder="e.g. My MailerLite Account">
        </div>
        <button type="submit" class="connect-action-btn" style="background: #00aaff; color: #ffffff;">
          <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
...
function disconnect() {
  if (!confirm('Are you sure you want to disconnect MailerLite? All synced data will be removed.')) return;
...
function connectApiKey(e) {
  ...
  fetch('{{ route("client.email-connections.store") }}', {
    ...
    body: JSON.stringify({
      ...
      settings: JSON.stringify({ color: '#00aaff', text_color: '#ffffff' })
    })
  })
  .then(r => r.json())
  .then(res => {
