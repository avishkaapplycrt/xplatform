...
@section('title', 'Connect Squarespace')
...
<header class="flex-shrink-0 bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between">
  <div class="flex items-center gap-3">
    ...
    <div class="flex items-center gap-2">
      ...
      <div>
        <h1 class="text-[16px] font-semibold text-gray-900">Connect Squarespace</h1>
...
<div class="flex-1 overflow-y-auto px-5 py-4">
  ...
  <div id="step-1" class="step-card mb-4">
    <div class="flex items-start gap-4">
      ...
      <div class="flex-1">
        <h3 class="text-[14px] font-bold text-gray-900 mb-1">Enter Your Squarespace Site Details</h3>
        <p class="text-[12px] text-gray-500 mb-4">Provide your Squarespace site URL and inject the tracking code via Code Injection.</p>

        <form id="connectForm" onsubmit="submitConnection(event)">
          <input type="hidden" id="modalPlatform" name="platform" value="squarespace">
          ...
          <div class="grid grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <p class="form-hint">The full URL of your Squarespace site</p>
            </div>
            <div>
              <label class="form-label">Site Name <span class="text-gray-400 font-normal">(optional)</span></label>
              <input type="text" name="site_name" class="form-input" placeholder="My Squarespace Site"
          ...
          <div class="mb-4">
            ...
            <div class="flex gap-2 mb-3">
              <button type="button" class="method-tab active" onclick="switchMethod('app')">Code Injection</button>
              <button type="button" class="method-tab" onclick="switchMethod('manual')">Code Block</button>
            </div>

            <div id="method-app" class="method-panel active">
              <div class="info-box mb-3">
                <p class="info-box-title">Code Injection</p>
                <p class="info-box-text">Use Squarespace Code Injection to add tracking to all pages automatically.</p>
              </div>
              <div class="mt-3">
              <div class="install-step"><div class="install-step-num">1</div><div class="install-step-text">Go to your Squarespace Admin → Settings → Advanced</div></div>
              <div class="install-step"><div class="install-step-num">2</div><div class="install-step-text">Click on Code Injection</div></div>
              <div class="install-step"><div class="install-step-num">3</div><div class="install-step-text">Paste the tracking code in the HEADER section</div></div>
              <div class="install-step"><div class="install-step-num">4</div><div class="install-step-text">Save changes — tracking applies to all pages instantly</div></div>
            </div>
            </div>

            <div id="method-manual" class="method-panel">
              <div class="info-box mb-3">
                <p class="info-box-title">Code Block</p>
                <p class="info-box-text">Add a Code Block to specific pages for targeted tracking.</p>
              </div>
              <div class="mt-3">
              <div class="install-step"><div class="install-step-num">1</div><div class="install-step-text">Edit the page where you want tracking</div></div>
              <div class="install-step"><div class="install-step-num">2</div><div class="install-step-text">Add a Code Block to the page footer</div></div>
              <div class="install-step"><div class="install-step-num">3</div><div class="install-step-text">Set the block type to HTML</div></div>
              <div class="install-step"><div class="install-step-num">4</div><div class="install-step-text">Paste the tracking code and save the page</div></div>
            </div>
            </div>
          </div>
  ...
  <div id="step-2" class="step-card mb-4">
    <div class="flex items-start gap-4">
      ...
      <div class="flex-1">
        ...
        <p class="text-[12px] text-gray-500 mb-4">Add this tracking code to your Squarespace site to start collecting events.</p>

        <div id="install-app" class="method-panel active">
          <div class="info-box mb-3">
            <p class="info-box-title">Code Injection Installation</p>
  ...
  <div id="step-3" class="step-card mb-4">
    <div class="flex items-start gap-4">
      ...
      <div class="flex-1">
        ...
        <p class="text-[12px] text-gray-500 mb-4">Your Squarespace site is now connected and tracking events.</p>
...
function disconnectSite() {
  if (!currentConnectionId) return;
  if (!confirm('Are you sure you want to disconnect this Squarespace site? All tracking will stop.')) return;
  ...
  .then(res => {
    if (res.success) {
      alert('Squarespace site disconnected successfully.');
