...
<link rel="canonical" href="{{ url('/banking') }}">
...
<section class="hero">
  <nav class="breadcrumb"><a href="{{ route('home') }}">Home</a> / <a href="{{ route('industries') }}">Industries</a> / <strong>Banking &amp; Finance</strong></nav>
  <div class="hero-inner">
    <div class="hero-left rv" style="opacity:1;transform:none">
      ...
      <div class="hero-btns">
        <a href="{{ route('simulator') }}" class="btn-fill">Run Banking Simulation</a>
...
<section class="sec-f"><div class="sw">
  ...
  <div class="cs-pull rv">
    <div class="csp-left">
      ...
      <a href="{{ route('case-studies') }}" class="btn-fill" style="margin-top:4px;display:inline-flex">Read Full Case Study &rarr;</a>
    </div>
    <div class="csp-right">
...
<section class="sec-f"><div class="sw">
  ...
  <div class="other-grid rv">
    <a href="{{ route('industries') }}" class="og"><div class="og-icon"><svg viewBox="0 0 24 24" stroke="var(--blue)" fill="none" stroke-width="1.6"><path d="M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4zM3 6h18"/></svg></div><div class="og-name">Retail</div><div class="og-stat">34% churn reduction</div></a>
    <a href="{{ route('industries') }}" class="og"><div class="og-icon"><svg viewBox="0 0 24 24" stroke="var(--emerald)" fill="none" stroke-width="1.6"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg></div><div class="og-name">Healthcare</div><div class="og-stat">28% compliance lift</div></a>
    <a href="{{ route('industries') }}" class="og"><div class="og-icon"><svg viewBox="0 0 24 24" stroke="var(--violet)" fill="none" stroke-width="1.6"><path d="M4 19.5A2.5 2.5 0 016.5 17H20M6.5 2H20v20H6.5A2.5 2.5 0 014 19.5v-15"/></svg></div><div class="og-name">Education</div><div class="og-stat">41% dropout reduction</div></a>
    <a href="{{ route('industries') }}" class="og"><div class="og-icon"><svg viewBox="0 0 24 24" stroke="var(--blue)" fill="none" stroke-width="1.6"><path d="M12 2L2 7l10 5 10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg></div><div class="og-name">All 15 Industries</div><div class="og-stat">View all verticals &rarr;</div></a>
  </div>
</div></section>
...
<section class="cta">
  ...
  <div class="rv" style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap">
    <a href="{{ route('simulator') }}" class="btn-fill">Run a Banking Simulation</a>
    <a href="{{ route('pricing') }}" class="btn-g">View Pricing</a>
  </div>
</section>
