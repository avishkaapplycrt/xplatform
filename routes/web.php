...
Route::middleware(['auth:client', 'client.active', 'client.onboarded'])->prefix('app')->name('client.')->group(function () {
    ...
    // Layer pages
    Route::get('layers/l1',      fn() => view('client.data-collection.mobile_events', array_merge(EmailLog::deliveryStats(), CallLog::callStats(), WebsiteEventsProviderHeader::providerOverviewStats())))->name('layer.l1');
